...
def parse(year, month, date, debugging):
    ...
    # 맛있는 메뉴 표시
    delicious = ['까스', '깐풍기', '꿔바로우', '도넛', '떡갈비', '떡꼬치', '떡볶이', '마요', '마카롱', '맛탕', '망고',
                 '메론', '미트볼', '바나나', '바베큐', '부대찌개', '불고기', '브라우니', '브라운', '브리또', '비엔나',
                 '빵', '샌드위치', '샐러드', '샤브샤브', '소세지', '송편', '스파게티', '스프', '아이스', '와플', '우동',
                 '쥬스', '짜장', '초코', '치즈', '치킨', '카레', '케이크', '케익', '쿠키', '쿨피스', '타코야끼',
                 '탕수육', '튀김', '파이', '파인애플', '피자', '하이라이스', '함박', '핫도그', '핫바', '햄', '햄버거',
                 '훈제']
